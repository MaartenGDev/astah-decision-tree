...
public class CreateActivityDiagram implements IPluginActionDelegate {

    private static final String PROJECT_PATH = "/Users/maarten/dev/asta/debugging/SampleActivity.asta";
    ...
    public Object run(IWindow window) {
        ...
        } catch (InvalidEditingException | InvalidUsingException | ClassNotFoundException | ProjectLockedException | LicenseNotFoundException | IOException | ProjectNotFoundException e) {
            e.printStackTrace();
        } finally {
